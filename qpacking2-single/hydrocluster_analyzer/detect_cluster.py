...
# Description: hydrophobic cluster detection for all hydrophobic residues, i.e. ILE, LEU, VAL, ALA, MET.
# ------------------------------------------------------------------------------
"""
import warnings
...
if __name__ == '__main__':
    from qpacking.common import visualization
    structure_file = r"/Users/douzhixin/Developer/qPacking/Data/GH5_2/2_StrucMapping/positive/3PZT_50.pdb"
    connected_graphs, structure = run(structure_file)
    visualization.show_hydrocluster_pymol(structure_file, connected_graphs)
