...
def get_dssp_dat(input_file_path):
    ...
    command_args = [dssp_path, input_file_path]
...
def batch_run(struct_dir):
    ...
    input_files = [os.path.join(struct_dir, i) for i in os.listdir(struct_dir)][:1]
...
if platform.system() == 'Windows':
    dssp_path = r"D:\qpacking\code\tools\dssp-3.0.0-win32.exe"
else:
    dssp_path = "mkdssp"

struct_dir = r"D:\qpacking\data\pdb"
